...
BOOST_AUTO_TEST_SUITE(InputHandlerTests)
	...
	{
		InputRouter router{ ButtonPressGestureHandler<SimpleEventComparitor>{}, TestInputHandler{} };
		router.handleEvent(1, sf::Event{});
	}

	static_assert(is_event_comparitor<SimpleEventComparitor>::value, "wat");
	static_assert(is_event_comparitor_v<SimpleEventComparitor>, "wat");
