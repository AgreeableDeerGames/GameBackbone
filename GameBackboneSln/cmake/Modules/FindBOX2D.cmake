# Based on the FindBox2D.cmake file from eXpl0it3r https://github.com/eXpl0it3r/Box2D/blob/master/cmake/FindBox2D.cmake
#
...
# find_package(BOX2D)
#
# If Box2D is not installed in a standard path, you can use the BOX2D_DIR or
...
mark_as_advanced(BOX2D_LIBRARY_DEBUG BOX2D_LIBRARY_RELEASE BOX2D_INCLUDE_DIR)

if(NOT BOX2D_INCLUDE_DIR OR NOT BOX2D_LIBRARY)
	if(BOX2D_FIND_REQUIRED)
		message(FATAL_ERROR "Box2D not found.\nDid you set BOX2D_ROOT OR BOX2D_DIR?\n")
	elseif(NOT BOX2D_FIND_QUIETLY)
		message("Box2D not found.")
		message("Did you set BOX2D_ROOT OR BOX2D_DIR?")
	endif()
else()
