...
/// <param name="object">The object whose updatability status will be changed. Passing nullptr is illegal.</param>
...
std::vector<Updatable*>const * const GameRegion::getUpdatables() {
	return updatables;
}
...
std::vector<sf::Sprite*>const * const GameRegion::getDrawables() {
	return drawables;
}
